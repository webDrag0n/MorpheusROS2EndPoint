...
static const _H1ControlCommand_type_support_symbol_names_t _H1ControlCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_demo_msgs, msg, H1ControlCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_demo_msgs, msg, H1ControlCommand)),
  }
};
...
{
  return &::unity_robotics_demo_msgs::msg::rosidl_typesupport_cpp::H1ControlCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_demo_msgs, msg, H1ControlCommand)() {
  return get_message_type_support_handle<unity_robotics_demo_msgs::msg::H1ControlCommand>();
}
